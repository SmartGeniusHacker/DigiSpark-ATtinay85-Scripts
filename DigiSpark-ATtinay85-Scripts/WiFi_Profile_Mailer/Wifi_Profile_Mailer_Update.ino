...
//NOTE about the New Version of this script: The older script stopped working on newer builds of Windows 11
//since Windows 10 now require an elevated cmd or powershell to execute these commands. This version should
//be faster (better, stronger...) and should work on all builds of Windows 11. For previous versions 
//of Windows or simply older builds of Windows 11, the other version works like a charm.
